...
A self-hosted, AI-augmented email client built on Svelte 5, FastAPI, and PostgreSQL. It connects to Gmail via the Google API and provides intelligent email management powered by OpenAI GPT and Anthropic Claude.
...
| AI / APIs      | OpenAI GPT, Anthropic Claude, Google Gmail API, Google Calendar API           |
...
- **OpenAI and/or Anthropic API key** (optional, for AI features -- keys can be added later)
...
| `OPENAI_API_KEY`       | OpenAI API key for GPT AI features                            | `sk-...`                                                       |
| `CLAUDE_API_KEY`       | Anthropic API key for Claude AI features                      | `sk-ant-api03-...`                                             |
...
│   │   ├── ai.py            #   Provider-neutral AI (categorization, replies, digests, bundles)
