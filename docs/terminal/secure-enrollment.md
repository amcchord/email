...
- Private firmware `main` is `fd8671bd9a3641ecf9af37491bb8a00607dec4d6`
  (`0.2.0-candidate.3`). Exact-main GitHub Actions run `33329094948` passed its
  keyed, cross-language, power-loss, and reproducibility checks.
